...
class Strategy:
    ...
    def analyze(self, df_1m: pd.DataFrame, df_15m: pd.DataFrame):
        ...
        # 1.2x — จับ pullback ธรรมชาติได้
        # แต่ยังมีความหมายว่า "ถูก reject"
        # ─────────────────────────────────────────
        ...
        # ─────────────────────────────────────────
        # [Filter 7] ATR Spike + Too Low Filter
        # ─────────────────────────────────────────
        ...
        # ─────────────────────────────────────────
        # [Filter 8] Doji Filter
        # ─────────────────────────────────────────
        is_valid_body = (body_size >= candle_size * 0.3) if candle_size > 0 else False

        # ─────────────────────────────────────────
        # RSI Zone
        # buy 50–72 : เกาะเทรนด์แรงได้ ตัด overbought จริงออก
        # sell 28–50 : สมมาตรกัน
        # ─────────────────────────────────────────
